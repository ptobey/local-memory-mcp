...
- MCP tools: `store`, `search`, `record_retrieval_feedback`, `update`, `delete`, `get_chunk`, `get_evolution_chain`, `get_recent`, `self_check`, `get_issues`, backup/restore, and conflict resolution
